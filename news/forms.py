...
class UserLoginForm(AuthenticationForm):
    username = forms.CharField(label='Имя пользователя', help_text='Имя пользователя не более 150 символов',
...
class NewsForm(forms.ModelForm):
    ...
    #                                   widget=forms.Select(attrs={"class": "form-control"}))  # поле для обработки связей
